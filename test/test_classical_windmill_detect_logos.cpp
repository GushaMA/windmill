...
int main(int argc, char *argv[])
{
    ...
    while (true)
    {
        ...
        // 计算风车Logo检测的准确率
        float logoAccuracy = static_cast<float>(logoIndex) / static_cast<float>(frameIndex);
        ...
        std::cout << "logo index: " << logoIndex << std::endl;
        std::cout << "logo accuracy: " << logoAccuracy << std::endl;
